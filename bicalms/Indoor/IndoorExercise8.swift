...
struct IndoorExercise8 : View {
    ...
    var body: some View {
        ...
        ZStack{
            ...
            if showAlert {
                indoorAlertView8(showAlert: $showAlert)
            }
        }
    }
            ...
            VStack {
                ...
                HStack{
                    ...
                    .accessibility(label: Text("Cancel"))
                                      .accessibility(hint: Text("To continue Squats exercise"))
...
struct IndoorExercise8_Previews: PreviewProvider {
    static var previews: some View {
        IndoorExercise8()
    }
}

class IndoorExerciseSquatVHC: UIHostingController<IndoorExercise8> {
    required init?(coder aDecoder: NSCoder) {
        super.init(coder: aDecoder, rootView: IndoorExercise8())
    }
}
