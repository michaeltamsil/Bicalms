...
struct IndoorExercise5B : View {
    ...
    var body: some View {
        ...
        ZStack{
            ...
            if showAlert {
                indoorAlertView5B(showAlert: $showAlert, countDown: $countDown)
            }
        }
    }
...
struct IndoorExercise5B_Previews: PreviewProvider {
