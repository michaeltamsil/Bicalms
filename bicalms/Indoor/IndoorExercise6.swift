...
struct IndoorExercise6 : View {
    ...
    var body: some View {
        ...
        ZStack{
            ...
            if showAlert {
                indoorAlertView6(showAlert: $showAlert, countDown: $countDown)
            }
        }
    }
    ...
    var body: some View {
        ...
        ZStack {
            ...
            VStack {
                ...
                HStack{
                    Button(action: {
                        coreDataAddItem(excercise: "Mountain Walkers on \(30 - self.countDown) seconds")
                        self.showAlert.toggle()
                    }){
                        Text("Leave")
                        .font(.headline)
...
struct IndoorExercise6_Previews: PreviewProvider {
    static var previews: some View {
        IndoorExercise6()
    }
}

class IndoorExerciseMountainWalkersVHC: UIHostingController<IndoorExercise6> {
    required init?(coder aDecoder: NSCoder) {
        super.init(coder: aDecoder, rootView: IndoorExercise6())
    }
}
