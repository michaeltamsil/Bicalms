...
struct IndoorExercise4B : View {
    ...
    var body: some View {
        ...
        ZStack{
            ...
            if showAlert {
                indoorAlertView4B(showAlert: $showAlert, countDown: $countDown)
            }
        }
    }
    ...
    var body: some View {
        ...
        ZStack {
            ...
            VStack {
                ...
                HStack{
                    Button(action: {
                        coreDataAddItem(excercise: "Flying Fast Ups on \(30 - self.countDown) seconds")
                        self.showAlert.toggle()
                    }){
                        Text("Leave")
                        .font(.headline)
...
struct IndoorExercise4B_Previews: PreviewProvider {
