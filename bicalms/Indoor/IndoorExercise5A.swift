...
struct IndoorExercise5A : View {
    ...
    var body: some View {
        ...
        ZStack{
            ...
            if showAlert {
                indoorAlertView5(showAlert: $showAlert, countDown: $countDown)
            }
        }
    }
    ...
    var body: some View {
        ...
        ZStack {
            ...
            VStack {
                ...
                HStack{
                    Button(action: {
                        coreDataAddItem(excercise: "Curtsy Lunge on \(30 - self.countDown) seconds")
                        self.showAlert.toggle()
                    }){
                        Text("Leave")
                        .font(.headline)
                ...
                .accessibility(hint: Text("To continue curtsy lunge exercise"))
                }
            }
        }
...
struct IndoorExercise5A_Previews: PreviewProvider {
    static var previews: some View {
        IndoorExercise5A()
    }
}

class IndoorExerciseCurtsyLungeLeftVHC: UIHostingController<IndoorExercise5A> {
