...
struct IndoorExercise9 : View {
    ...
    var body: some View {
        ...
        ZStack{
            ...
            if showAlert {
                indoorAlertView9(showAlert: $showAlert, countDown: $countDown)
            }
        }
    }
    ...
    var body: some View {
        ...
        ZStack {
            ...
            VStack {
                ...
                HStack{
                    Button(action: {
                        coreDataAddItem(excercise: "Burpees on \(30 - self.countDown) seconds")
                        self.showAlert.toggle()
                    }){
                        Text("Leave")
                        .font(.headline)
                    ...
                    .accessibility(hint: Text("To continue Burpees exercise"))
                }
            }
        }
...
struct IndoorExercise9_Previews: PreviewProvider {
    static var previews: some View {
        IndoorExercise9()
    }
}
class IndoorExerciseBurpeesVHC: UIHostingController<IndoorExercise9> {
    required init?(coder aDecoder: NSCoder) {
        super.init(coder: aDecoder, rootView: IndoorExercise9())
    }
}
