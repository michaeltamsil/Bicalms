...
struct IndoorExercise3A : View {
    ...
    var body: some View {
        ...
        ZStack{
            ...
            if showAlert {
                indoorAlertView3(showAlert: $showAlert, countDown: $countDown)
            }
        }
    }
        ...
        ZStack {
            ...
            VStack {
                ...
                HStack{
                    ...
                    .accessibility(hint: Text("To continue Overhead Side Knees exercise"))
                }
            }
        }
...
struct IndoorExercise3A_Previews: PreviewProvider {
    static var previews: some View {
        IndoorExercise3A()
    }
}

class IndoorExerciseGoofyJacksVHC: UIHostingController<IndoorExercise3A> {
    required init?(coder aDecoder: NSCoder) {
        super.init(coder: aDecoder, rootView: IndoorExercise3A())
    }
}
