        ...
        ZStack{
            ...
            VStack(spacing: 64){
                ...
                HStack{
                    ...
                    .accessibility(hint: Text("To close Overhead Side Knees right side exercise"))
                }
                ...
                VStack(spacing: 460){
                    ...
                    VStack(spacing: 4){
                        ...
                        Text("Overhead Side Knees (R)")
                            .font(.title)
                            .fontWeight(.semibold)
                            .foregroundColor(.white)
                            .accessibility(label: Text("Overhead Side Kneesf right exercise"))
                    }
            ...
            if showAlert {
                indoorAlertView3B(showAlert: $showAlert, countDown: $countDown)
            }
        }
    }
    ...
    var body: some View {
        ...
        ZStack {
            ...
            VStack {
                ...
                HStack{
                    Button(action: {
                        coreDataAddItem(excercise: "Overhead Side Knees on \(30 - self.countDown) seconds")
                        self.showAlert.toggle()
                    }){
                        Text("Leave")
                        .font(.headline)
                ...
                .accessibility(hint: Text("To continue overhead side knees"))
                }
            }
        }
...
struct IndoorExercise3B_Previews: PreviewProvider {
    static var previews: some View {
        IndoorExercise3B()
    }
}
class IndoorExerciseOverheadVHC: UIHostingController<IndoorExercise3B> {
    required init?(coder aDecoder: NSCoder) {
        super.init(coder: aDecoder, rootView: IndoorExercise3B())
    }
}
