...
struct IndoorExercise10 : View {
    ...
    var body: some View {
        ...
        ZStack{
            ...
            if showAlert {
                indoorAlertView10(showAlert: $showAlert, countDown: $countDown)
            }
        }
    }
    ...
    var body: some View {
        ...
        ZStack {
            ...
            VStack {
                ...
                HStack{
                    Button(action: {
                        coreDataAddItem(excercise: "Jumping on \(30 - self.countDown) seconds")
                        self.showAlert.toggle()
                    }){
                        Text("Leave")
                        .font(.headline)
...
struct IndoorExercise10_Previews: PreviewProvider {
    static var previews: some View {
        IndoorExercise10()
    }
}

class IndoorExerciseJumpingVHC: UIHostingController<IndoorExercise10> {
    required init?(coder aDecoder: NSCoder) {
        super.init(coder: aDecoder, rootView: IndoorExercise10())
    }
}
