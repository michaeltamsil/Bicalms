        ...
        ZStack{
            ...
            VStack(spacing: 64){
                ...
                HStack{
                    ...
                    .accessibility(hint: Text("To close Lunge exercise"))
                }
                ...
                VStack(spacing: 460){
                    ...
                    VStack(spacing: 4){
                        ...
                        Text("Lunge")
                            ...
                            .fontWeight(.semibold)
                            .foregroundColor(.white)
                            .accessibility(label: Text("Lunge exercise"))
                    }
            ...
            if showAlert {
                indoorAlertView7(showAlert: $showAlert, countDown: $countDown)
            }
        }
    }
    ...
    var body: some View {
        ...
        ZStack {
            ...
            VStack {
                ...
                HStack{
                    Button(action: {
                        coreDataAddItem(excercise: "Lunge on \(30 - self.countDown) seconds")
                        self.showAlert.toggle()
                    }){
                        Text("Leave")
                        .font(.headline)
                ...
                .accessibility(hint: Text("To continue lung exercise"))
...
struct IndoorExercise7_Previews: PreviewProvider {
...
class IndoorExerciseLungeVHC: UIHostingController<IndoorExercise7> {
    required init?(coder aDecoder: NSCoder) {
        super.init(coder: aDecoder, rootView: IndoorExercise7())
    }
}
