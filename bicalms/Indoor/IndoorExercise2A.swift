...
struct IndoorExercise2A : View {
    ...
    var body: some View {
        ...
        ZStack{
            ...
            if showAlert {
                indoorAlertView2(showAlert: $showAlert, countDown: $countDown)
            }
        }
    }
...
struct IndoorExercise2A_Previews: PreviewProvider {
    static var previews: some View {
        IndoorExercise2A()
    }
}
class IndoorExerciseGoofyVHC: UIHostingController<IndoorExercise2A> {
    required init?(coder aDecoder: NSCoder) {
        super.init(coder: aDecoder, rootView: IndoorExercise2A())
    }
}
