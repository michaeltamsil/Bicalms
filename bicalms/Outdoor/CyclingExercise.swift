...
struct CyclingExercise : View {
    ...
    var body: some View {
        ...
        ZStack{
            ...
            if showAlert {
                customAlertView4(showAlert: $showAlert, countDown: $countDown)
            }
            
            if showFinish {
                finishAlertView4(showFinish: $showFinish, countDown: $countDown)
            }
        }
    }
...
struct CyclingExercise_Previews: PreviewProvider {
    static var previews: some View {
        CyclingExercise()
    }
}

struct customAlertView4 : View {
    ...
    var body: some View {
        ...
        ZStack {
            ...
            VStack {
                ...
                HStack{
                    Button(action: {
                        coreDataAddItem(excercise: "Cycling on \(self.countDown) seconds")
                        self.showAlert.toggle()
                    }){
                        Text("Leave")
                        .font(.headline)
...
class CyclingExerciseVHC: UIHostingController<CyclingExercise> {
    required init?(coder aDecoder: NSCoder) {
        super.init(coder: aDecoder, rootView: CyclingExercise())
    }
}
