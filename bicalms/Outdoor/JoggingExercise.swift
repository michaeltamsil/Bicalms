...
struct JoggingExercise : View {
    ...
    var body: some View {
        ...
        ZStack{
                        ...
                        HStack{
                            ...
                            .accessibility(hint: Text("Show the example how to jogging exercise move"))
                                ...
                                VStack {
                                    ...
                                    .accessibility(hint: Text("To stop current jogging exercise"))
            ...
            if showAlert {
                customAlertView2(showAlert: $showAlert, countDown: $countDown)
            }
            
            if showFinish {
                finishAlertView2(showFinish: $showFinish, countDown: $countDown)
            }
        }
    }
...
struct JoggingExercise_Previews: PreviewProvider {
    ...
    var body: some View {
        ...
        ZStack {
            ...
            VStack {
                ...
                HStack{
                    Button(action: {
                        coreDataAddItem(excercise: "Jogging on \(self.countDown) seconds")
                        self.showAlert.toggle()
                    }){
                        Text("Leave")
                        .font(.headline)
...
class JoggingExerciseVHC: UIHostingController<JoggingExercise> {
    required init?(coder aDecoder: NSCoder) {
        super.init(coder: aDecoder, rootView: JoggingExercise())
    }
}
